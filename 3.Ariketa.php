...
<!-- Hemen Motagatik bilatzeko aukera izango dugu-->
<form method="get" action="3.Ariketa.php">
    <label for="bilaketa">Mota bilatu</label>
...
if (isset($_GET["bilaketa"])) {
    ...
    // Hemen $kontsula-n Mysql-ko eskaera idazten da kasu honetan motaren arabera bilatzeko
    $kontsulta = "SELECT id, izena, mota, prezioa FROM markatze.produktuak WHERE mota LIKE '%$bilaketa%'";
